...
const Card2 = ({image, name, data,data2,data3,data4,data5,data6,data7,data8,data9, title, des, parts,price, brand, rank}) => {
      ...
      >
        <div className="card w-full bg-base-100  image-full cursor-pointer">
          ...
          Add To Cart
            ...
            <h2 className="card-title text-right text-yellow-600 pt-4">{rank}</h2>
            <h2 className="card-title text-left text-green-600 pt-4">{price}</h2>
            <h2 className="card-title text-left text-orange-600 pt-4">{brand}</h2>
